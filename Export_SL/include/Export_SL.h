...
//! Example qCC plugin
/** Replace 'Export_SL' by your own plugin class name throughout and then
	check 'Export_SL.cpp' for more directions.
...
**/
class Export_SL : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA( IID "cccorp.cloudcompare.plugin.Export_SL" FILE "../info.json" )

public:
	explicit Export_SL( QObject *parent = nullptr );
	~Export_SL() override = default;
